...
// --- CAMBIO: Desactivado para que no intente conectar a un servidor que no existe ---
...
chrome.runtime.onMessage.addListener((msg,sender,sendResponse)=>{
  try{
    ...
    if(msg?.type==='getVideos'){
      (async ()=>{
        ...
        for(const e of bucket.list){
          ...
          const originOK=(videoOrigin==='blob-data://') || (videoOrigin===curOrigin);
    ...
    // Este es el receptor para el botón "Descargar" del popup
