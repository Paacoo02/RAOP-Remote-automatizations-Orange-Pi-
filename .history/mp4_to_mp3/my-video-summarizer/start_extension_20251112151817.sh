...
# =================== HELPERS ===================
▶️  Boot script: start_extension
./start_extension.sh: línea 32: error de sintaxis cerca del elemento inesperado `}'
(base) iMac-de-Paco:my-video-summarizer paco$ sed -n '32p' ./start_extension.sh
  }
(base) iMac-de-Paco:my-video-summarizer paco$ sed -n '30,35p' ./start_extension.sh
    fi
    sleep "${sleep_s}"
  }
...
(base) iMac-de-Paco:my-video-summarizer paco$ 
