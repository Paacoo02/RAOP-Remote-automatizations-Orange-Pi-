...
// ===================================================================
// BLOQUE AÑADIDO: Oyente para peticiones desde el POPUP
// ===================================================================
try {
  chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
    ...
    // Petición desde popup.js para volcar el DOM
    if (msg?.type === 'dbg.dumpDOM') {
      console.log('VID_EXT (content.js): Recibida petición de volcado de DOM');
