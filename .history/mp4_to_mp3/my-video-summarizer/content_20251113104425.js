 ...
 ***********************/
const byTab=new Map();
const injectedFrame=new Set();
const pageThumbByTab=new Map();
...
chrome.runtime.onMessage.addListener((msg,sender,sendResponse)=>{
  try{
    ...
    if(msg?.type==='dbg.ping'){ 
      // Ahora logueamos 'from' Y 'extra'
      devlog('DBG','PING',{from:msg.from||'unknown', extra: msg.extra || null}); 
