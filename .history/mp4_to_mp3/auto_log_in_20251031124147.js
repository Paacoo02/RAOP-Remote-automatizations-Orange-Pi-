...
async function createUndetectableBrowser() {
  console.log('🚀 Creando navegador Playwright…');
  console.log('[DEBUG] chromium.executablePath() =', chromium.executablePath());

  const browser = await chromium.launch({
    headless: false,
    // NO pongas executablePath; Playwright ya sabe usar /ms-playwright/chromium-1193/...
    args: [
      '--no-sandbox',
...
async function attemptGoogleLogin() {
  ...
  // Devolver pestaña limpia con Drive abierto
