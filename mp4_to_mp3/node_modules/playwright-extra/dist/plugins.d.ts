import { Plugin, PluginMethodName, PluginMethodFn, CompatiblePluginModule } from 'playwright-extra/dist/types';
export declare class PluginList {
     ...
     */
    get list(): import("playwright-extra/dist/types").PuppeteerExtraPlugin[];
    /**
    ...
    protected filterByMethod(methodName: PluginMethodName): import("playwright-extra/dist/types").PuppeteerExtraPlugin[];
